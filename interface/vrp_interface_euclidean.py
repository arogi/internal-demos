...
def main():
    ...
    objective = RunVRP(numFeatures)
    generateGEOJSON(objective)
    
    
def RunVRP(numFeatures):
...
def SolveModel():
  ...
  if numFeatures > 1:
    ...
    if assignment:
      ...
      # return route_dist   # this might be a more accurate respresentation of the actual solution distance
    else:
